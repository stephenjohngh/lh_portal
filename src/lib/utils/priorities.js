...
export const PRIORITIES = [
  { value: 1, label: 'Top Priority', color: 'bg-red-600' },
  { value: 2, label: 'Major Project', color: 'bg-orange-600' },
  { value: 3, label: 'Important', color: 'bg-yellow-600' },
  { value: 4, label: 'Minor', color: 'bg-green-600' },
  { value: 5, label: 'Pending', color: 'bg-blue-600' }
];
