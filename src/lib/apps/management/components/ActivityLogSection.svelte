...
<script>
  ...
  // Shared mutation state for the edit / delete / move flows (the add form
  // is now a self-contained AddActivityForm with its own saving/error).
  let mutationError = '';
  let saving        = false;
